...
int benchmark_matrix_multiplication(unsigned runs) {
    ...
    std::cout << "[Benchmark] Matrix Multiplication: RAII version took " << (total_duration_raii / runs) << " microseconds\n";
    std::cout << "[Benchmark] Matrix Multiplication: Original version took " << (total_duration_origin / runs) << " microseconds\n";
